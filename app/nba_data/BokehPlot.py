...
from bokeh.models import Slider, Select, FileInput
from app.nba_data.Season import Season
...
def modify_doc(doc):
    ...
    column1 = column(widgetbox(menu), widgetbox(slider), widgetbox(file_input))
    ...
    file_input.on_change("value", callback)
